...
### Шаг 6
- [ ] Написать тесты на контроллер задач.
- [ ] Реализовать CRUD задач. Подключить флэш сообщения.
- [ ] Добавить ссылку на список задач в основное меню.
- [ ] Сделать так, чтобы добавлять, редактировать задачи могли бы только залогиненные пользователи. Удалять задачи может только создатель.
- [ ] В качестве языка по умолчанию использовать английский, все переводы и локализацию хранить в i18n. Организовать хранение текстов в i18n и их подстановку в шаблоне.
