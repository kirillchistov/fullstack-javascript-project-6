...
### Шаг 5
- [ ] Фронт: Создать страницу статусов и создания статусов, аналогично демонстрационному проекту и добавьте ссылку на неё в основном меню
- [ ] Бэк: Написать тесты для CRUD статусов.
- [ ] Реализовать CRUD статусов.
- [ ] Подключить флэш сообщения, как в демо-проекте.
- [ ] Добавить ссылку на список статусов в основное меню.
- [ ] Сделать так, чтобы добавлять, редактировать и удалять статусы могли бы только залогиненные пользователи.
